DROP TABLE IF EXISTS imaging_satellite CASCADE;
DROP TABLE IF EXISTS communication_satellite CASCADE;
DROP TABLE IF EXISTS satellite CASCADE;
DROP TABLE IF EXISTS satellite_constellation CASCADE;
DROP TABLE IF EXISTS energy_system CASCADE;
